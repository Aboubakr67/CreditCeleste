...
namespace CreditCeleste  // Mon tp
{
    class Concession
    {
       ...
       private string stockVehicule;
        ...
        public string getMonNomConcession() // ok
        {
            return monNomConcession;
        }

        public void setMonNomConcession(string leNomConcess) // ok
        {
            monNomConcession = leNomConcess;
        }

        public string getTelConcession() //ok
        {
            return telConcession;
        }

        public void setTelConcession(string leTelConcession) //ok
        {
            telConcession = leTelConcession;
        }

        public void setMailConcession(string leMailConcession) //ok
        {
            mailConcession = leMailConcession;
        }

        public string getMailConcession() //ok
        {
